...
参考：[Intro to Animations | Python | Plotly](https://plotly.com/python/animations/)

## Plotly Express 动画

一些 [Plotly Express]((plotly:plotly-express) 函数支持通过 `animation_frame` 和 `animation_group` 参数创建动画图。
...
The remainder of this section describes the low-level [graph objects](plotly:graph-objects) API for constructing animated figures manually.
